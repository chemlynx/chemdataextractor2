...
from chemdataextractor.nlp.cem import CiDictCemTagger
from chemdataextractor.nlp.cem import CrfCemTagger
    ...
    def test_unicode_combining_characters(self):
        ...
        self.assertEqual(
            ...
            dt.legacy_tag(
                [
                    "Novel",
                    "imidazo\xfd1,2-a\xa8pyridine",
                    "and",
                    "imidazo\xfd1,2-b\xa8pyridazine",
                    "derivatives",
                ]
            ),
        )
