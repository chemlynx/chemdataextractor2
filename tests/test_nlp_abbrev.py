...
class TestChemAbbreviationDetector(unittest.TestCase):
    ...
    def test_abbr3_on_sentence(self):
        ...
        self.assertEqual(
            ...
            ad.detect(
                Sentence(
                    "protencies of DON, 15-acetyldeoxynivalenol (15-ADON), 3-acetyldeoxynivalenol (3-ADON), "
                    "fusarenon X (FX) and nivalenol (NIV) in"
                ).raw_tokens
            ),
        )
    ...
    def test_abbr4(self):
        ...
        ad = ChemAbbreviationDetector()
        self.assertEqual(
            [(["THF"], ["tetrahydrofuran"])], ad.detect(["THF", "=", "tetrahydrofuran"])
        )
