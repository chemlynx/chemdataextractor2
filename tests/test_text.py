...
class TestNormalization(unittest.TestCase):
    def test_normalize(self):
        ...
        self.assertEqual(
            ...
            normalize("The\u0003 quick br\u0005own fo\u0008x jumped"),
        )
...
class TestLaTeX(unittest.TestCase):
    def test_latex_to_unicode_names(self):
        ...
        self.assertEqual(
            "Bernd van Linder", latex_to_unicode("Bernd van Linder", capitalize="name")
        )
        self.assertEqual(
            "John-Jules Ch. Meyer",
    ...
    def test_latex_to_unicode_titles(self):
        self.assertEqual(
            "A guide for ChemDataExtractor",
            latex_to_unicode("A Guide For {ChemDataExtractor}", capitalize="sentence"),
        )
        self.assertEqual(
            "A Guide for ChemDataExtractor",
            latex_to_unicode("A Guide For {ChemDataExtractor}", capitalize="title"),
        )
        self.assertEqual(
            "A Guide for ChemDataExtractor",
            latex_to_unicode("A Guide For {ChemDataExtractor}", capitalize="title"),
