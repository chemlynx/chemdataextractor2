...
class TestSnowball(unittest.TestCase):
    ...
    def test_retrieve_entities(self):
        ...
        expected = [
            ("1103", ("curietemperature", "raw_value")),
            ("K", ("curietemperature", "raw_units")),
            ("Curie temperature", ("curietemperature", "specifier")),
            ("BiFeO3", ("compound", "names")),
        ]
