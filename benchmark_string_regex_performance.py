...
class StringRegexBenchmark:
    ...
    def __init__(self, iterations: int = 1000):
        ...
        self.error_strings = [
            "100±5", "25.3±0.1", "123(45)", "456.7(8.9)", "78±2.1", 
            "1000±50", "0.5(0.1)", "234±15", "89.2(3.4)", "567±23"
        ] * 10  # Multiply for realistic batch size
        
        self.value_strings = [
            "100-200", "25.5-30.2", "-100", "1000", "123 456", 
            "78.9±2.1", "45(3)", "scientific 1.5e3", "range 10-20",
            "negative -45.2", "decimal 123.456", "integer 789"
        ] * 10
        
        self.unit_strings = [
            "mg/kg", "cm/s", "mol/L", "m2", "kg3", "(mg)", "unit(special)",
            "kg⋅m/s2", "mol/(L⋅s)", "°C", "kJ/mol", "g/cm3", "Hz", "Pa⋅s"
        ] * 10
        
        self.float_strings = [
            "123(45)", "456.7±8.9", "1.5×10^3", "2.3x10^-4", "100±5",
            "123.45,", "$123.45", "(123.45)", "123 456", "  123.45  ",
            "1,234.56", "12,345", "0(1)", "123.0(0.1)", "1000(50)"
        ] * 10
        
        self.normalizer_strings = [
            "aluminum sulphate", "cesium chloride", "SULPHUR compound",
            "aluminum oxide", "cesium", "sulphur dioxide", "Aluminum",
            "normal chemical text", "benzene solution", "sodium chloride"
        ] * 10
        
        self.tokenizer_strings = [
            "benzene", "sodium chloride", "H2SO4", "C6H6", "25°C", "100mg",
            "2,4-dichlorobenzene", "α-methylstyrene", "tert-butanol",
            "The melting point of benzene (C6H6) is 5.5°C at 1 atm pressure.",
            "CH3-CH2-OH", "1.5×10^3", "±0.1", "α-helix β-sheet"
        ] * 5
        ...
        """ * 20  # Multiply for realistic document size
    ...
    def benchmark_find_value_strings_operations(self):
        ...
        self.results['find_value_strings_operations'] = self.time_function(test_find_value_strings_batch)
        self.results['find_value_strings_operations']['strings_per_iteration'] = len(self.value_strings)
    ...
    def benchmark_normalizer_operations(self):
        ...
        self.results['normalizer_operations']['strings_per_iteration'] = len(self.normalizer_strings)
    ...
    def benchmark_raw_regex_operations(self):
        ...
        test_patterns = [
            ...
            r"sulph", r"aluminum", r"cesium"  # normalization patterns
        ]
        
        test_strings = [
            "100±5", "123(45)", "text(more)", "456.7±8.9", "1.5×10^3",
            "aluminum sulphate", "cesium chloride", "100 - 200"
        ]
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Benchmark ChemDataExtractor string regex performance')
    parser.add_argument('--iterations', '-i', type=int, default=500,
                       help='Number of iterations for each test (default: 500)')
    parser.add_argument('--output', '-o', type=str, default='string_regex_baseline.json',
