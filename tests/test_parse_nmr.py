...
class TestParseNmr(unittest.TestCase):
    ...
    def test_nmr1(self):
        s = (
            "1H NMR (300 MHz, CDCl3), 1.00 (t, J = 7.3 Hz, 3H), 1.50 (m, 2H), 1.77 (m, 2H), 2.42 (s, 3H), "
    ...
    def test_nmr2(self):
        s = (
            "1H NMR (400 MHz, DMSO) δ 8.34 (s, 1H), 8.10 (d, J = 9.3 Hz, 1H), 7.70 (s, 2H), 3.82–3.65 (m, 1H), "
    ...
    def test_nmr4(self):
        s = (
            "1H NMR (C6D6, 400 MHz): δ -0.53 (s, 1H), 0.72 (d, 1H, J = 4.0 Hz), 0.98 (s, 1H), 1.58 (s, 15H), "
    ...
    def test_nmr6(self):
        ...
        s = (
            "1H NMR (CDCl3 with 0.05% v/v TMS, 400 MHz): δH 7.10 (2H, d, J = 8.9 Hz, H2′ and H6′), "
    ...
    def test_nmr7(self):
        """With 2D."""
        s = (
            "13C NMR (CDCl3, 125 MHz): δC 170.6 (s, COCH32), 160.6 (s, C4a), 160.0 (s, C6), 158.8 (s, C4′), "
    ...
    def test_nmr8(self):
        """d of d multiplicity."""
        s = (
            "1H NMR (D2O, 300 MHz): δ 1.61 (s, 6H), 1.68 (s, 3H), 1.72 (s, 3H), 2.17-1.99 (m, 8H), "
