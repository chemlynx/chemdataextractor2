...
class QuantityModelTemplateParser(BaseAutoParser, BaseSentenceParser):
    ...
    def prefix(self):
        ...
        return (
            ...
            + Optional(
                ...
                | I("high")
                | I("low")
                | ((I("higher") | I("lower") | I("more") | I("less")) + I("than"))
                | I("order")
                | (I("for") + I("instance"))
                | (I("up") + I("to"))
                | I("reaching")
            ...
            + Optional(I("of")).hide()
            + ZeroOrMore(lbrct | delim | rbrct)
            + Optional(W("=") | W("~") | W("≈") | W("≃") | W(">") | W("<")).hide()
            + ZeroOrMore(lbrct | delim | rbrct).hide()
        ).add_action(join)
    ...
    def cem_before_specifier_and_value_phrase(self):
        ...
        return (
            self.cem_phrase
            + OneOrMore(
                Not(self.cem_phrase | self.specifier_phrase | self.specifier_and_value)
                + Any().hide()
            )
    ...
    def value_specifier_cem_phrase(self):
        ...
        return (
            ...
            + Optional(I("corresponds") | I("associated") | I("corresponding")).hide()
    ...
    def root(self):
        """Root Phrases"""
        root_phrase = Group(
            self.specifier_before_cem_and_value_phrase
...
class MultiQuantityModelTemplateParser(BaseAutoParser, BaseSentenceParser):
    ...
    def multi_entity_phrase_3a(self):
        ...
        return Group(
            ...
            + self.prefix
            + self.list_of_values
            + Optional(delim.hide() + I("respectively").hide())
    ...
    def root(self):
        return (
            self.multi_entity_phrase_1
            | self.multi_entity_phrase_2
            | self.multi_entity_phrase_3
            | self.multi_entity_phrase_4
            | self.multi_entity_phrase_5
        )
