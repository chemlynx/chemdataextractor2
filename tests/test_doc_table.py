...
from chemdataextractor.parse.cem import ChemicalLabelParser
from chemdataextractor.parse.cem import CompoundHeadingParser
from chemdataextractor.parse.cem import CompoundParser
from chemdataextractor.parse.cem import CompoundTableParser
from chemdataextractor.parse.elements import Every
from chemdataextractor.parse.elements import Group
from chemdataextractor.parse.elements import I
from chemdataextractor.parse.elements import Not
...
class CoordinationNumber(DimensionlessModel):
    ...
    coordination_number_label = Group(
...
class TestTable(unittest.TestCase):
    ...
    def do_table_1(self, expected):
        ...
        table = Table(
            caption=Caption("This is my table."),
        ...
        expected = [
            {
                "InteratomicDistance": {
                    ...
                    "value": [3.1814],
                    "units": "Angstrom^(1.0)",
                    "specifier": "bonddistances",
                    "species": "Mg-Mg",
                    "compound": {"Compound": {"names": ["Mg2Si"]}},
                }
            },
            {
                "InteratomicDistance": {
        ...
        expected = [
            {
                "CurieTemperature": {
                    ...
                    "units": "Kelvin^(1.0)",
                    "specifier": "TD",
                    "compound": {"Compound": {"names": ["PrMnO3"]}},
                }
            },
            {
                "CurieTemperature": {
