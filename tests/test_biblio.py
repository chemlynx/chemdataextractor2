...
from chemdataextractor.biblio import BibtexParser
from chemdataextractor.biblio import PersonName
    ...
    def test_parse_names(self):
        ...
        self.assertEqual(
            ...
            BibtexParser.parse_names(
                "Bernd {van Linder} and {John-Jules Ch.} Meyer and Eijkhof, Frank {v}an {d}en"
            ),
        )
        res = ['John "Jack and Jill" Smith', "Tom Thompson"]
        self.assertEqual(
            res,
            BibtexParser.parse_names('John "Jack {and} Jill" Smith and Tom Thompson'),
        )
