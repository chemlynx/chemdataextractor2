...
class TestParseCem(unittest.TestCase):
    ...
    def test_comma_separated(self):
        ...
        expected = [
            "<cem_phrase><compound><names>4-Amino-3-chloro-6-(2,3,4-trifluorophenyl)pyridine-2-carboxylic acid, methyl ester</names><labels>67</labels></compound></cem_phrase>"
        ]
        self.do_parse(s, expected)
    ...
    def test_high_label_colon(self):
        ...
        expected = [
            "<cem_phrase><compound><names>4-Amino-3-chloro-6-[2,4-dichloro-3-(1-fluoro-1-methylethylphenyl)pyridine-3-carboxylic acid</names><labels>127</labels></compound></cem_phrase>"
        ]
        self.do_parse(s, expected)
    ...
    def test_no_trailing_semicolon(self):
        ...
        expected = [
            "<cem_phrase><compound><names>2-[1-(3-Bromo-phenyl)-1H-imidazol-4-yl]-benzooxazole</names></compound></cem_phrase>"
        ]
        self.do_parse(s, expected)
    ...
    def test_section_numeral(self):
        ...
        expected = [
            "<cem_phrase><compound><names>1,3,5-Tricyano-2,4,6-tris[4-(p-diphenylaminostyryl)styryl]benzene</names><labels>3j</labels></compound></cem_phrase>"
        ]
        self.do_parse(s, expected)
    ...
    def test_section_numeral2(self):
        ...
        expected = [
            "<cem_phrase><compound><names>1,3,5-Tricyano-2,4,6-tris(2-dimethylaminovinyl)benzene</names><labels>1f</labels></compound></cem_phrase>"
        ]
        self.do_parse(s, expected)
    ...
    def test_inorganic_chemical_formula_5(self):
        ...
        expected = [
            "<cem_phrase><compound><names>Ba0.55K0.45As2Fe2+δ</names></compound></cem_phrase>"
        ]
        self.do_parse(s, expected)
...
class TestParseCemHeading(unittest.TestCase):
    ...
    def test_section_number2(self):
        ...
        expected = [
            "<compound><roles>Preparation of</roles><names>4-acetylamino-3-chloro-6-iodopyridine-2-carboxylic acid, methyl ester</names></compound>"
        ]
        self.do_parse(s, expected)
    ...
    def test_example_name(self):
        ...
        expected = [
            "<compound><roles>EXAMPLE</roles><labels>436</labels><names>N-tert-Butyl-3-[6 \u2032-methyl-4 \u2032-(4-trifluoromethoxy-phenyl)-[2,2 \u2032]bipyridinyl-6-yl]-benzenesulfonamide</names></compound>"
        ]
        self.do_parse(s, expected)
    ...
    def test_label_list(self):
        ...
        expected = [
            "<compound><roles>Compounds</roles><labels>8a</labels><labels>8b</labels><labels>8c</labels></compound>"
        ]
        self.do_parse(s, expected)
...
class TestParseHeading(unittest.TestCase):
        ...
        expected = [
            {
                "Compound": {
                    "labels": ["41"],
                    "names": [
                        "4-Amino-3-chloro-6-(2,3,4-trifluorophenyl)pyridine-2-carboxylic acid, methyl ester"
                    ],
                    "roles": ["compound", "product"],
                }
            }
        ]
        self.do_parse(s, expected)
    ...
    def test_label_list(self):
        s = "Compounds 8a, 8b, 8c: pH Responsive Dye Conjugates"
        expected = [
            {"Compound": {"labels": ["8a"], "roles": ["compounds"]}},
        ...
        expected = [
            {
                "Compound": {
                    "labels": ["8b"],
                    "names": [
                        "4-[4-(4-[5-[5-(4-Hydroxyphenyl)-3-phenyl-1H-pyrrol-2-ylimino]-4-phenyl-5H-pyrrol-2-yl]-phenoxymethyl)-[1,2,3]triazol-1-yl]butyric acid"
                    ],
                }
            }
        ]
    ...
    def test_cas(self):
        """"""
        s = "CAS 1242336-53-3"
        expected = [{"Compound": {"names": ["CAS 1242336-53-3"]}}]
        self.do_parse(s, expected)
    ...
    def test_example_colon(self):
        """"""
        s = "EXAMPLE: 3"
        expected = [{"Compound": {"labels": ["3"], "roles": ["example"]}}]
        self.do_parse(s, expected)

    def test_comparative_example(self):
        """"""
        s = "Comparative example 14"
        expected = [{"Compound": {"labels": ["14"], "roles": ["comparative example"]}}]
        self.do_parse(s, expected)

    def test_reference_example(self):
        """"""
        s = "Reference example IV"
        expected = [{"Compound": {"labels": ["IV"], "roles": ["reference example"]}}]
        self.do_parse(s, expected)
        ...
        expected = [
            {
                "Compound": {
                    "labels": ["11"],
                    "names": ["2-(10-bromoanthracene-9-yl)thiophene"],
                    "roles": ["product"],
                }
            }
        ]
...
class TestParseLabelPhrase(unittest.TestCase):
    ...
    def test_synthesis_of_compound(self):
        ...
        expected = [
            "<chemical_label_phrase><roles>Synthesis of</roles><roles>Compound</roles><labels>23</labels></chemical_label_phrase>"
        ]
        self.do_parse(s, expected)
    ...
    def test_synthesis_of(self):
        ...
        expected = [
            "<chemical_label_phrase><roles>synthesis of</roles><labels>4a</labels></chemical_label_phrase>"
        ]
        self.do_parse(s, expected)
    ...
    def test_compound(self):
        ...
        expected = [
            "<chemical_label_phrase><roles>Compound</roles><labels>IV</labels></chemical_label_phrase>"
        ]
        self.do_parse(s, expected)

    def test_synthesis_of2(self):
        r"""Test synthesis of \d on its own."""
        s = "Synthesis of 10."
        expected = [
            "<chemical_label_phrase><roles>Synthesis of</roles><labels>10</labels></chemical_label_phrase>"
        ]
        self.do_parse(s, expected)
    ...
    def test_to_give_phrase(self):
        ...
        expected = [
            "<chemical_label_phrase><roles>to give</roles><labels>10</labels></chemical_label_phrase>"
        ]
        self.do_parse(s, expected)
    ...
    def test_afforded_phrase(self):
        ...
        expected = [
            "<chemical_label_phrase><roles>afforded</roles><labels>12</labels></chemical_label_phrase>"
        ]
        self.do_parse(s, expected)
    ...
    def test_doped_label_1(self):
        ...
        expected = [
            "<chemical_label_phrase><labels>x = 0.1 , 0.2 , 0.3 and 0.4</labels></chemical_label_phrase>"
        ]
        self.do_parse(s, expected)
    ...
    def test_informal_label_1(self):
        ...
        expected = [
            "<chemical_label_phrase><labels>LN = Ho , Dy , La and Tb</labels></chemical_label_phrase>"
        ]
        self.do_parse(s, expected)
...
class TestParseDocument(unittest.TestCase):
    ...
    def test_consecutive_headings(self):
        d = Document(
            ...
            Heading("Example 3"),
            Paragraph(
                "The solid is suspended in hexanes, stirred and filtered to give the product as a bright yellow solid. (MP 93-94\xc2\xb0 C.)."
            ),
        )
        d.models = [Compound]
        ...
        self.assertEqual(
            ...
            [
                {"Compound": {"names": ["hexanes"]}},
                {
                    "Compound": {
                        "labels": ["3"],
                        "names": ["2-Amino-3-methoxy-5-chloropyridine"],
                        "roles": ["example", "product"],
                    }
                },
            ],
        )
    ...
    def test_consecutive_headings2(self):
        ...
        self.assertCountEqual(
            ...
            [
                ...
                {
                    "Compound": {
                        "names": ["5-Bromo-6-pentadecyl-2-hydroxybenzoic acid", "DBAA"],
                        "roles": ["product"],
                    }
                },
                {"Compound": {"labels": ["VII"], "roles": ["formula"]}},
