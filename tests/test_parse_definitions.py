...
from chemdataextractor.parse.definitions import greek_symbols
from chemdataextractor.parse.definitions import specifier_definition
...
class CurieTemperature(TemperatureModel):
    ...
    specifier = StringType(
        parse_expression=specifier_expr, required=True, contextual=True, updatable=True
    )
