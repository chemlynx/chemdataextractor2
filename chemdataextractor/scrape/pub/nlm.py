...
strip_pmc_xml = Cleaner(
    strip_xpath=".//*",
    kill_xpath='.//disp-formula|.//inline-formula|.//mml:math|.//xref[@ref-type="bibr"]|.//xref[@ref-type="p"]|.//xref[@ref-type="fn"]|.//fn|.//private-char',
    namespaces={"mml": "http://www.w3.org/1998/Math/MathML"},
)
#: XML stripper that also kills headings
strip_pmc_abstract_xml = Cleaner(
    strip_xpath=".//*",
    kill_xpath='.//disp-formula|.//inline-formula|.//mml:math|.//xref[@ref-type="bibr"]|.//xref[@ref-type="p"]|.//xref[@ref-type="fn"]|.//fn|.//private-char|.//title',
    namespaces={"mml": "http://www.w3.org/1998/Math/MathML"},
)
#: XML stripper that also kills tables and figures
strip_pmc_paragraph_xml = Cleaner(
    strip_xpath=".//*",
    kill_xpath='.//disp-formula|.//inline-formula|.//mml:math|.//xref[@ref-type="bibr"]|.//xref[@ref-type="p"]|.//xref[@ref-type="fn"]|.//fn|.//private-char|.//table-wrap|.//fig',
    namespaces={"mml": "http://www.w3.org/1998/Math/MathML"},
)
...
class NlmXmlDocument(Entity):
    ...
    pmid = IntField(
        '/article/front/article-meta/article-id[@pub-id-type="pmid"]/text()', xpath=True
    )
    pmcid = IntField(
        '/article/front/article-meta/article-id[@pub-id-type="pmc"]/text()', xpath=True
    )
    title = StringField("/article/front/article-meta//article-title", xpath=True)
    authors = EntityField(
        NlmXmlAuthor,
        '/article/front/article-meta//contrib[@contrib-type="author"]',
        xpath=True,
        all=True,
    )
    ...
    coden = StringField(
        '/article/front/journal-meta/journal-id[@journal-id-type="coden"]/text()',
        xpath=True,
        all=True,
    )
    abstract = StringField("/article/front/article-meta/abstract", xpath=True)
    online_year = IntField(
        '/article/front/article-meta/pub-date[@pub-type="epub"]/year/text()', xpath=True
    )
    online_month = IntField(
        '/article/front/article-meta/pub-date[@pub-type="epub"]/month/text()',
        xpath=True,
    )
    online_day = IntField(
        '/article/front/article-meta/pub-date[@pub-type="epub"]/day/text()', xpath=True
    )
    published_year = IntField(
        '/article/front/article-meta/pub-date[@pub-type="ppub"]/year/text()', xpath=True
    )
    published_month = IntField(
        '/article/front/article-meta/pub-date[@pub-type="ppub"]/month/text()',
        xpath=True,
    )
    published_day = IntField(
        '/article/front/article-meta/pub-date[@pub-type="ppub"]/day/text()', xpath=True
    )
    accepted_year = IntField(
        '/article/front/article-meta/history/date[@date-type="accepted"]/year/text()',
        xpath=True,
    )
    accepted_month = IntField(
        '/article/front/article-meta/history/date[@date-type="accepted"]/month/text()',
        xpath=True,
    )
    accepted_day = IntField(
        '/article/front/article-meta/history/date[@date-type="accepted"]/day/text()',
        xpath=True,
    )
    received_year = IntField(
        '/article/front/article-meta/history/date[@date-type="received"]/year/text()',
        xpath=True,
    )
    received_month = IntField(
        '/article/front/article-meta/history/date[@date-type="received"]/month/text()',
        xpath=True,
    )
    received_day = IntField(
        '/article/front/article-meta/history/date[@date-type="received"]/day/text()',
        xpath=True,
    )
    license = UrlField(
        "/article/front/article-meta/permissions/license/@xlink:href|/article/front/article-meta/permissions/license//ext-link/@xlink:href",
        xpath=True,
    )
