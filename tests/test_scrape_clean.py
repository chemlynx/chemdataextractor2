...
from chemdataextractor.scrape.clean import strip
from chemdataextractor.scrape.clean import strip_html
from chemdataextractor.scrape.clean import strip_markup
...
class TestCleaner(unittest.TestCase):
    ...
    def test_strip_markup_doc(self):
        ...
        self.assertEqual(
            original_string, tostring(original_tree).decode()
        )  # tree shouldn't change as strip_markup copies
    ...
    def test_strip_kill_strong1(self):
        ...
        cleaner = Cleaner(
            strip_xpath=".//*",
            kill_xpath=".//script | .//style | .//comment() | .//processing-instruction() | .//strong",
        )
        tree = html.fromstring(HTML1)
        cleaner(tree)
