...
strip_springer_xml = Cleaner(
    strip_xpath=".//*",
    kill_xpath=".//display-formula|.//inline-formula|.//m:math|.//abbrgrp",
    namespaces={"m": "http://www.w3.org/1998/Math/MathML"},
)
#: XML stripper that also kills headings
strip_springer_abstract_xml = Cleaner(
    strip_xpath=".//*",
    kill_xpath=".//display-formula|.//inline-formula|.//m:math|.//abbrgrp|.//st",
    namespaces={"m": "http://www.w3.org/1998/Math/MathML"},
)
...
class SpringerHtmlDocument(DocumentEntity):
    ...
    abstract = StringField(
        '//section[@class="Abstract"]/p | //div[@class="AbstractSection"]/p ',
        xpath=True,
    )
