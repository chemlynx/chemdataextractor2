...
strip_els_xml = Cleaner(
    strip_xpath=".//ce:inf | .//ce:italic | .//ce:bold | .//ce:formula | .//mml:* | .//ce:sup | .//ce:table//ce:sup | .//ce:inter-ref | .//ce:cross-ref ",
    kill_xpath=".//ce:cross-ref//ce:sup | .//ce:note-para | .//ce:cross-refs | .//ce:float-anchor",
    process_xpaths={
        ".//ce:cross-ref//ce:sup | .//ce:cross-ref | .//ce:cross-refs": remove_if_reference
    },
)
...
class ElsevierXmlReader(XmlReader):
    ...
    ignore_css = (
        "ce|bibliography, ce|acknowledgment, ce|correspondence, ce|author, ce|doi, ja|jid, ja|aid, ce|pii, xocs|oa-sponsor-type, xocs|open-access, default|openaccess,"
